...
async function main() {
    ...
    try {
        await pool.request()
            .input('UserId', mssql_1.default.UniqueIdentifier, user.Id)
            .input('RoleSlug', mssql_1.default.NVarChar(100), roleSlug)
            .input('WorkspaceId', mssql_1.default.UniqueIdentifier, workspaceId ?? null)
            .input('AssignedBy', mssql_1.default.UniqueIdentifier, null)
